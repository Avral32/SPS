...
import os
from functions import maxima_reference, plot_line, plot_line_annotate, ps_maxima_matrix, transpose_power_matrix
...
df_OD_1p0['Int'] = df_OD_1p0['Int']-df_background['Int']

#%%

num_maxima = 10     # number of expected maxima (ordered by intensity)

plot_line(df_OD_1p0['Wavelength'],
          df_OD_1p0['Int'],
          'Wavelength (nm)',
          'Intensity (a.u.)',
...
ps_maxima_matrix = ps_maxima_matrix(df_background,
                                    maxima_frame, 
                                    power_series,
                                    directory,
                                    file_name,
...
ps_transpose_res = transpose_power_matrix(power_series,
                                ps_maxima_matrix)
